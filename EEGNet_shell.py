...
data_file_name = 'Cybersick_randpermu.mat'
DATA_FOLDER_PATH = '/media/eeglab/YG_Storage/cyberwell/EEGNET/'
...
data_x = mat_2['train_x']
data_y = mat_2['train_y']
data_y = data_y[:, 1]
